...
<a href="${pageContext.request.contextPath}/queryComment.book">←返回</a>
...
<section class="mes-send">
    ...
    <form action="${pageContext.request.contextPath}/saveAnsComment.book" method="post" class="STYLE-NAME">
